...
public class CommentDao extends AbstractMFlixDao {
    ...
    public Comment addComment(Comment comment) {
        ...
        if (comment.getId() == null) {
            throw new IncorrectDaoOperation("_id is null");
        }
    ...
    public boolean updateComment(String commentId, String text, String email) {
        ...
        if (comment != null) {
            UpdateResult updateResult = commentCollection.updateOne(queryFilter, setComment);
            return updateResult.wasAcknowledged();
        }


//    Document updateFilter = new Document("_id",commentId)
//            .append("email",email);
//    Document setComment = new Document("$set",new Document("text",text)
//            .append("date","ISODate()"));
        log.info("---------" + queryFilter.toString());
        log.info("---------" + setComment.toString());

//    commentCollection.updateOne(queryFilter,setComment);
